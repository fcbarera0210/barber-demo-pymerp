        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {services.map((service, idx) => (
            <motion.article
              ...
              className="group p-6 sm:p-8 bg-zinc-900/50 hover:bg-zinc-900/80 transition-all rounded-lg border border-white/5 shadow-sm hover:shadow-md hover:border-white/10"
            >
              <div className="flex items-center gap-4 mb-4">
                {service.icon && (
                  <div className="p-3 bg-zinc-800 group-hover:bg-accent transition-colors rounded">
                    <Icon icon={service.icon} className="text-3xl text-accent group-hover:text-white" />
                  </div>
                )}
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-4">
                ...
                <button
                  ...
                  className="btn-accent bg-accent text-white px-5 py-2.5 text-xs font-bold tracking-widest hover:bg-white hover:text-[var(--accent)] transition-all rounded-sm"
                >
                  Reservar
                </button>
              </div>
